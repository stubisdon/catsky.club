...
- Express has a defensive fallback proxy for `/content/images/*` and `/r/*`, but this is a safeguard only; nginx route ownership for those prefixes is still required in production.
