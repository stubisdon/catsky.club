...
- Logged-out visitors who watch a video to completion, listen actively for a few minutes, or play several songs may see a one-time email-capture popup asking them to sign up; it does not appear on `/subscribe`, `/welcome`, or `/connect`, and it will not reappear for a while after being dismissed, or ever again once the visitor signs up or is already a member.
