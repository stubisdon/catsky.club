...
5. **Unsubscribe links:** open a real newsletter unsubscribe URL and confirm it does not fall through to `/` and never redirects to a localhost/127.0.0.1 address
