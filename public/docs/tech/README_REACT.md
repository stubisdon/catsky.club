...
- `/welcome` - New-user onboarding for first/last name after signup callback; continue queues a background profile save and immediately routes to `/listen` (Welcome.tsx)
